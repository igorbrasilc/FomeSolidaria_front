...
export default function Step6(props: Props) {
  ...
  const { register, handleSubmit, formState: { errors } } = useForm<DoneeFormData['note']>();
  const { setMessage } = useAlert();
  const key = Object.keys({ ...errors })[0] as keyof DoneeFormData['note'];
